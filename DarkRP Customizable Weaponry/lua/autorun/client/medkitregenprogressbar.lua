...
CreateClientConVar("cstm_hud_ammo", "0", false, false)
CreateClientConVar("cstm_hud_health", "0", false, false)
CreateClientConVar("cstm_hud_health_different", "0", false, false)
...
local function CSTM_InitPostEntity()
	...
	timer.Simple(10, function()
		chat.AddText(Color(255, 255, 255, 255), "To Place Hits On this Server Do !hit in chat and a menu will appear, This Server Uses Customizable Weaponry.")
		chat.AddText(Color(255, 255, 255, 255), "Weapon Attachments Can Be Bought From Gun Dealers, For The Controls, type ", Color(141, 201, 0, 255), "cstm_controls", Color(255, 255, 255, 255), " in console. For The FAQ, type ", Color(141, 201, 0, 255), "cstm_faq", Color(255, 255, 255, 255), " in console. ")
	end)
end
