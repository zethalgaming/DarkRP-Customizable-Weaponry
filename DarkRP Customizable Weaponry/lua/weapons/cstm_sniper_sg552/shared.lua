...
if ( CLIENT ) then
	...
	SWEP.WElements = {
		["silencer"] = { type = "Model", model = "models/props_c17/oildrum001.mdl", pos = Vector(24.613, 0.194, -3.582), angle = Angle(-90, 0, 0), size = Vector(0.057, 0.057, 0.165), color = Color(255, 255, 255, 1), surpresslightning = false, material = "models/bunneh/silencer", skin = 0, bodygroup = {} },
